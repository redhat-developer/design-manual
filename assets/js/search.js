(function( $ ) {
	...
	$.fn.camelHunter.defaults = {
		...
		rss 				      : "/rss-alternate",
		onKeyUp 			    : true,
		result_template   : "<li class='pf-c-data-list__item' aria-labelledby='results'><div class='pf-c-data-list__item-content'><div class='pf-c-data-list__cell'><div><b id='page-title'><a href='{{link}}' aria-label='{{title}}'>{{title}}</a></b><p>{{description}}</p></div></div></div></li>",
