    ...
    <div class="large-24 columns">
      <div class="row">
        ...
        <div class="large-24 columns" id="scrollPoint">
          ...
          <nav id="paginator" ng-hide="loading" ng-if="paginate.pages &gt; 1"><span ng-bind-template="Showing -{{paginate.lastVisible}} of  {{totalCount}} results"></span>
            <ul class="pagination">
<li id="pagination-first" ng-class="paginate.currentPage &lt; 2 ? 'unavailable': 'available'">
              ...
              <li class="pagination-page-number" id="pagination-" ng-class="{current: page == paginate.currentPage}" ng-repeat="page in paginate.pagesArray track by $index">
